...
export function SiteFooter({ currentYear, isMenuOpen }: SiteFooterProps) {
  return (
    <footer
      className={`relative isolate flex-1 pt-16 transform-gpu transition-transform duration-300 ease-in-out md:transition-[margin,transform,filter] border-t border-border/60 bg-background/80 py-8 backdrop-blur supports-backdrop-filter:bg-background/60 ${isMenuOpen
