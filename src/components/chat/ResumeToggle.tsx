...
import { FileUp, FileCheck, FileX, Loader2 } from "lucide-react";
import clsx from "clsx";

import { parseResumeFile, isSupportedResumeFile } from "@/lib/resume/parser";
import {
    hasProfile,
    isContextEnabled,
    setContextEnabled,
        ...
        <>
            ...
            {buttonState === "has-profile" ? (
                ...
                <button
                    ...
                    title={contextEnabled ? "Click to disable resume context" : "Click to enable resume context"}
                >
                    {contextEnabled ? (
                        <>
