/**
 * Canvas Document Definitions
 *
 * Defines the schema and types for AI-generated documents in the canvas interface.
 * Controls the structure of resumes, cover letters, and reports generated by the
 * `generateDocument` tool.
 *
 * @module lib/canvas/documents
 * @see {@link ../../app/api/chat/route.ts} for tool integration
 */
...
export const documentSectionSchema = z.object({
  ...
  body: z
    .string()
    .describe(
      "Main content of the section. Supports markdown and bullet lists.",
    ),
  meta: z
    .string()
...
export const documentInputSchema = z.object({
  ...
  summary: z
    ...
    .max(200)
    .describe(
      "A brief, contextual description of what was created or changed. Example: 'Created a resume highlighting your sports management experience' or 'Updated your resume to emphasize leadership roles'.",
    )
    .optional(),
 ...
 */
export function isGeneratedDocument(
  payload: unknown,
): payload is GeneratedDocument {
