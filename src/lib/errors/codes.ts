...
export const ErrorMessages: Record<ChatErrorCodeValue, string> = {
  ...
  [ChatErrorCode.CHAT_LIMIT_REACHED]:
    "Message limit reached for this conversation. Start a new chat.",
  [ChatErrorCode.EMPTY_RESPONSE]:
    "The AI couldn't generate a response. Please try again.",
  [ChatErrorCode.MODEL_UNAVAILABLE]:
    "This model is currently unavailable. Please try a different one.",
  [ChatErrorCode.STREAM_INTERRUPTED]:
    "The connection was interrupted. Please try again.",
  [ChatErrorCode.INVALID_PAYLOAD]:
