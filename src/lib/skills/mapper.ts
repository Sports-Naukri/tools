...
export const SKILL_MAPPINGS = [
    {
        ...
        roles: ["Sports Data Analyst", "Fan Insights Analyst", "Business Intelligence Analyst"],
        seniority: "Entry → Senior",
        tools: ["Excel", "SQL", "Power BI", "Tableau", "Python (pandas)"],
        training: ["Data Analytics Specialization", "Google Data Analytics", "SQL courses"],
        searchKeywords: ["sports data analyst", "fan insights"],
    },
    {
        skill: "Statistical modelling",
        keywords: ["statistics", "statistical", "modeling", "modelling", "r programming", "spss"],
        function: "Analytics / Research",
        roles: ["Performance Statistician", "Quant Analyst", "Sports Scientist (data)"],
    ...
    },
    {
        ...
        keywords: ["machine learning", "ml", "ai", "artificial intelligence", "deep learning", "tensorflow"],
    ...
    },
    {
        ...
        keywords: ["visualization", "tableau", "power bi", "dashboard", "charts", "graphs"],
        function: "Analytics / BI",
    ...
    },
    {
        ...
        keywords: ["performance", "video analysis", "hudl", "sportscode", "match analysis"],
    ...
    },
    {
        ...
        keywords: ["strength", "conditioning", "s&c", "fitness", "gym", "training", "workout"],
    ...
    },
    {
        ...
        keywords: ["physiotherapy", "physio", "rehabilitation", "rehab", "injury", "physical therapy"],
        function: "Medical",
    ...
    {
        skill: "Nutrition",
        keywords: ["nutrition", "diet", "dietitian", "nutritionist", "meal planning", "food"],
    ...
    {
        skill: "Coaching",
        keywords: ["coaching", "coach", "training", "teaching", "mentoring", "tactics"],
        function: "Coaching",
    ...
    },
    {
        ...
        keywords: ["scouting", "scout", "talent", "recruitment", "player identification"],
    ...
    },
    {
        ...
        keywords: ["event", "events", "operations", "tournament", "logistics", "matchday"],
        function: "Events / Ops",
    ...
    {
        skill: "Sponsorship",
        keywords: ["sponsorship", "sponsor", "partnership", "commercial", "brand partnership"],
    ...
    {
        skill: "Marketing",
        keywords: ["marketing", "brand", "campaign", "digital marketing", "advertising"],
        function: "Marketing",
    ...
    {
        skill: "Social media",
        keywords: ["social media", "instagram", "twitter", "facebook", "content", "community"],
    ...
    },
    {
        ...
        keywords: ["video", "editing", "production", "premiere", "after effects", "filming"],
    ...
    {
        skill: "Journalism",
        keywords: ["journalism", "journalist", "writing", "reporter", "commentary", "broadcasting"],
        function: "Media / PR",
    ...
    },
    {
        ...
        keywords: ["pr", "public relations", "communications", "media relations", "press"],
        function: "PR / Comms",
    ...
    {
        skill: "Finance",
        keywords: ["finance", "accounting", "budget", "financial", "revenue", "money"],
        function: "Finance",
    ...
    {
        skill: "HR",
        keywords: ["hr", "human resources", "people", "recruitment", "hiring", "talent acquisition"],
        function: "People",
    ...
    },
    {
        ...
        keywords: ["software", "developer", "coding", "programming", "javascript", "python", "react", "frontend", "backend"],
        function: "Tech",
        roles: ["Frontend/Backend Engineer", "Fullstack Developer", "Sports Tech Developer"],
        seniority: "Entry → Senior",
    ...
    {
        skill: "Psychology",
        keywords: ["psychology", "mental", "sports psychology", "mindset", "mental health"],
        function: "Welfare",
        roles: ["Sports Psychologist", "Athlete Welfare Lead", "Mental Performance Coach"],
        seniority: "Mid → Senior",
    ...
    },
    {
        ...
        keywords: ["data engineering", "pipeline", "etl", "airflow", "spark", "aws", "gcp", "kafka"],
    ...
    },
    {
        ...
        keywords: ["medicine", "doctor", "physician", "medical", "clinical", "diagnosis"],
        function: "Medical",
    ...
    },
    {
        ...
        keywords: ["pathway", "academy", "development", "curriculum", "youth development"],
    ...
    {
        skill: "Logistics",
        keywords: ["logistics", "supply chain", "equipment", "transport", "inventory", "operations"],
        function: "Operations",
    ...
    {
        skill: "Ticketing",
        keywords: ["ticketing", "customer service", "box office", "ticketmaster", "tessitura", "sales"],
    ...
    },
    {
        ...
        keywords: ["sales", "hospitality", "corporate", "renewals", "upsell", "negotiation"],
        function: "Commercial / Sales",
    ...
    },
    {
        ...
        keywords: ["broadcast", "production", "live", "switchers", "encoding", "ob truck"],
    ...
    {
        skill: "E-commerce",
        keywords: ["e-commerce", "ecommerce", "online sales", "shopify", "salesforce", "digital retail"],
    ...
    },
    {
        ...
        keywords: ["commercial", "strategy", "revenue", "monetisation", "growth", "business development"],
    ...
    },
    {
        ...
        keywords: ["scouting analytics", "recruitment data", "wins", "abund", "wyscout", "instat", "opta"],
    ...
    },
    {
        ...
        keywords: ["wearables", "sensors", "gps", "catapult", "stat", "imu", "accelerometer"],
    ...
    {
        skill: "QA & testing",
        keywords: ["qa", "quality assurance", "testing", "selenium", "automation", "manual testing"],
    ...
    },
    {
        ...
        keywords: ["grounds", "turf", "pitch", "grass", "irrigation", "greenkeeping"],
        function: "Facilities",
    ...
    },
    {
        ...
        keywords: ["sustainability", "esg", "environmental", "carbon", "green", "eco"],
    ...
    },
    {
        ...
        keywords: ["research", "academic", "phd", "lecturer", "university", "study"],
        function: "Research",
    ...
    },
    {
        ...
        keywords: ["community", "grassroots", "participation", "outreach", "development"],
        function: "Community",
    ...
    {
        skill: "Refereeing",
        keywords: ["referee", "umpire", "official", "rules", "officiating", "arbitration"],
    ...
    },
    {
        ...
        keywords: ["governance", "policy", "regulation", "compliance", "regulatory", "drafting"],
        function: "Governance",
...
export const skillMapperInputSchema = z.object({
    skills: z.array(z.string()).min(1).max(10).describe("Array of user skills to map to sports industry roles"),
});
...
export function mapSkillsToRoles(input: SkillMapperInput): SkillMapperOutput {
    ...
    for (const userSkill of skills) {
        ...
        for (const mapping of SKILL_MAPPINGS) {
            const skillMatches = mapping.keywords.some(keyword =>
    ...
    const uniqueMappings = mappings.filter(
        (mapping, index, self) => index === self.findIndex(m => m.matchedSkill === mapping.matchedSkill)
    );
